        ...
        <div>
            <footer className="body-font bg-black mt-0">
                <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                  <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-yellow-500 sm:py-2 sm:mt-0 mt-4">© 2021
                    <span className="text-white ml-1" rel="noopener noreferrer">PolyTickets • All rights reserved</span>
                  </p>
                  <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    <a className="text-white" href="mailto:akhileshthite@hotmail.com" target="_blank">
                    ...
                    <a className="ml-4 text-gray-500" href="https://twitter.com/AkhileshThite_" target="_blank">
