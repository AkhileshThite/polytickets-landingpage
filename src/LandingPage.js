...
import GIF from "./images/ethereum.gif"
  ...
  return (
    <div>
        ...
        <section className="header">
          ...
          <img className="gif inline-flex" src={GIF} value="Ethereum GIF"/>
        </section>
          {/* about */}
              ...
              <div className="flex flex-wrap -m-4">
                ...
                <div className="xl:w-1/3 md:w-1/2 p-4">
                  <div className="border border-gray-200 p-6 rounded-lg">
                    ...
                    <p class="leading-relaxed text-base">Costs associated with selling and minting NFTs are negligible on Polygon as compared to the traditional ticketing system.<br/></p>
                  </div>
                </div>
                <div className="xl:w-1/3 md:w-1/2 p-4">
                  <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                <div className="flex relative pb-12">
                  ...
                  <div className="flex-grow pl-4">
                    <h2 className="font-medium title-font text-sm text-yellow-400 mb-1 tracking-wider">18 NOV 2021</h2>
                    <p className="leading-relaxed">Build on idea.</p>
                  </div>
                </div>
                <div className="flex relative pb-12">
                  <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                  ...
                  <div className="flex-grow pl-4">
                    <h2 className="font-medium title-font text-sm text-yellow-400 mb-1 tracking-wider">23 NOV 2021</h2>
                ...
                <div className="flex relative pb-12">
                  ...
                  <div className="flex-grow pl-4">
                    <h2 className="font-medium title-font text-sm text-yellow-400 mb-1 tracking-wider">28 NOV 2021</h2>
                ...
                <div className="flex relative pb-12">
                  ...
                  <div className="flex-grow pl-4">
                    <h2 className="font-medium title-font text-sm text-yellow-400 mb-1 tracking-wider">12 DEC 2021</h2>
                ...
                <div className="flex relative">
                  ...
                  <div className="flex-grow pl-4">
                    <h2 className="font-medium title-font text-sm text-yellow-400 mb-1 tracking-wider">Jan 2022</h2>
                    <p className="leading-relaxed">Final launch on Ethereum & Polygon main network.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
              ...
              <div className="w-full lg:w-1/2 px-4 py-2">
                <details className="mb-4">
                  ...
                  <span className="text-gray-400">
                    Polygon previously known as the Matic Network, Polygon is an interoperability layer two (L2) scaling solution for building Ethereum-compatible blockchains. The gas fees are almost negligible on the Polygon network.
                  </span>
                </details>
                <details className="mb-4">
                  <summary className="font-semibold  bg-gray-200 rounded-md py-2 px-4">
